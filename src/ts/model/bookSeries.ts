import { KaiDiscipline, MgnDiscipline, GndDiscipline, mechanicsEngine , Disciplines, NewOrderDiscipline } from "..";
...
export class BookSeries {
    ...
    public static readonly series: BookSeries[] = [
        ...
        new BookSeries(BookSeriesId.NewOrder, 21, 28, 5, NewOrderDiscipline.GrandWeaponmastery, 1, NewOrderDiscipline.KaiScreen, 25, 30)
    ];
